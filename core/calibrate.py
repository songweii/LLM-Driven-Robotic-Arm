...
class Calibration(object):
    ...
    def tcp_pose(self):
        ...
        # txt_path = os.path.join("C:\\Users\\24432\\Desktop\\demo1\\demo\\output\\imgSave\\Folder_2024_07_06_17_22_33\\calibration.txt")
    ...
    def get_pix_and_points(self):
        ...
        for i in range(self.img_num):
            # img = cv.imread(os.path.join(f"C:\\Users\\24432\\Desktop\\demo1\\demo\\output\\imgSave\\Folder_2024_07_06_17_22_33\\img_{i + 1}.jpg"))
