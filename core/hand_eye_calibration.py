...
def create_parser():
    ...
    parser.add_argument('--robot_ip', type=str, default='192.168.200.1', help='robot ip')
...
if __name__ == "__main__":
    ...
    for index in tqdm(range(image_num), desc='Progress: '):
        # random action
        robot.read_csv_and_calibrate(index)
    ...
    # image_num =16
    Calibration(size=(8, 5), size_step=2.6, img_num=image_num, cal_path=dir_path)()

    print_and_write(None, f"Calibration END.", 33, 1)


    # 标定回滚
    # Calibration(size=(8, 5), size_step=2.6, img_num=16, cal_path="C:\\Users\\24432\\Desktop\\demo1\\demo\\output\\imgSave\\Folder_2024_07_06_18_15_14_2.365")()
