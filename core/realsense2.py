...
class Realsense2(object):
    def __init__(self, id=0, rgb_width=640, rgb_height=480, rgb_fps=30,
                 is_depth=False, is_depth_pix=False, is_colormap=False, is_filter=False, is_fps=False):
        """
